...
<div class="  tituloformulario tfmargen gris" style="margin-left: 16px; color: #373737;text-align:center;margin-top:16px; margin-right:20px;font-size:26px; width:284px"><?php echo $this->variables['aDatosAnuncio']['nombreMunicipio']; ?></div>

                     
<div class="   tfmargen gris" style="margin-left: 16px; color: #373737;text-align:center;margin-right:20px; padding-top: 20px;font-size:14px; width:284px">Contacta con <b><?php echo $this->variables['aDatosAnuncio']['nombre']; ?></b> </div>
<div class="negrita   gris" style="padding-bottom: 10px;margin-left: 16px; color: #373737;text-align:center;margin-right:20px;font-size:20px; width:284px"><?php echo $this->variables['aDatosAnuncio']['telefono']; ?></div>               
                    <div   style=" background-color:#fcfcfc;
                        ...
                        <table style="margin-left:10px;font-size:14px; margin-top: 5px;">
                            ...
                            <input type="hidden" value="<?php echo $this->variables['idAnuncio']; ?>" name="idAnuncio" />
