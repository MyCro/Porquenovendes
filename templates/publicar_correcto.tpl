<div id="cpublicar">
    ...
    <div class="formcentro" >
        ...
        <table class="isubestilo">  
            <tr> <td>Estimad@ <a>{$sNombre}</a>, su anuncio ha sido insertado correctamente.<br /> Podr&aacute;s visualizarlo en el listado de anuncios de la web. <br />
                <br />
                <a href="{$urlAnuncio}">VER ANUNCIO</a>
